# 利用testing数据库提取的左右心室于ED和ES期的体积（利用shape特征类的meshvolume特征）来计算左右心室射血分数
# 射血分数计算公式：EF(%)= ((EDV-ESV)*100)/EDV. (because SV= EDV-ESV).

import pandas as pd

docu= [r'testing3\result10.csv', r'testing3\result11.csv', r'testing3\result12.csv', r'testing3\result13.csv']
...
rvs.to_csv(r'testing3\result14.csv')